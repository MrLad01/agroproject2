...
const tabContent: Record<string, { paragraphs: string[]; videoSrc: string }> = {
  bedroom: {
    paragraphs: [
      'The deluxe bedroom at Agroterra Resort is thoughtfully designed to provide a warm, spacious, and relaxing environment where families can unwind, reconnect, and enjoy quality time together. From the moment guests enter, they are welcomed by a calming atmosphere inspired by nature, comfort, and modern elegance. The room is carefully arranged to balance functionality with a sense of retreat, ensuring that every family member feels at home throughout their stay.',
      ...
      <main className="flex flex-col w-full bg-white">
        ...
        >
          ...
          <MediaContainer>
            <Image
              src={deluxe}
              alt={activeTab === 'bedroom' ? 'Deluxe bedroom' : 'Deluxe bathroom'}
              fill
