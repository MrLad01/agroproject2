...
const tabContent: Record<string, {
  ...
  bedroom: {
    ...
    paragraphs: [
      'The deluxe bedroom at Agroterra Resort is thoughtfully designed to provide a warm, spacious, and relaxing environment where families can unwind, reconnect, and enjoy quality time together. From the moment guests enter, they are welcomed by a calming atmosphere inspired by nature, comfort, and modern elegance.',
      'The layout is intentionally spacious to accommodate families comfortably without feeling crowded. A large, comfortable king size bed serves as the centerpiece for parents, dressed in premium linens, soft pillows, and a plush duvet that promises restful sleep.',
      'Natural light plays an important role in the room\'s ambiance. Large windows or sliding glass doors invite sunlight to fill the space during the day while offering beautiful views of the resort\'s lush greenery, landscaped gardens, or serene natural surroundings.',
      'The interior design reflects the spirit of Agroterra, blending natural textures, warm earth tones, and modern finishes. Wooden accents, soft fabrics, and subtle decorative elements create a welcoming environment that feels both luxurious and grounded.',
      'Modern amenities are thoughtfully integrated to enhance convenience and entertainment. A large flat screen television with family friendly channels, high speed wireless internet, and multiple charging ports ensure that both adults and children stay connected and entertained.',
      'For added comfort, the family bedroom is equipped with climate control, allowing guests to adjust the temperature to their liking regardless of the season. A mini refrigerator, coffee and tea station, and complimentary bottled water add a touch of convenience.',
    ],
    videoSrc: 'https://www.youtube.com/embed/CdNSFf2hjEE?si=WUJXoytTL9YNF4W-',
  },
  bathroom: {
    eyebrow: 'Suite 01',
    title: 'Deluxe Ensuite',
    tagline: 'Clean · Spacious · Refreshing',
    size: '12 sqm', beds: '—', bath: '1 Bath', guests: '4 Guests',
    paragraphs: [
      'The deluxe bathroom at Agroterra Resort is designed to complement the comfort of the bedroom while offering a clean, spacious, and refreshing environment suitable for guests of all ages. With a focus on hygiene, functionality, and modern elegance, the bathroom provides everything families need.',
      'The bathroom features a modern walk in shower with high quality fittings that deliver a consistent and relaxing water experience. In select rooms, a full size bathtub is also available, providing families with the option of a soothing soak or a fun and safe bathing experience for younger children.',
      'Cleanliness and comfort are at the heart of the design. Fresh, soft towels, bath mats, and premium toiletries are provided daily. Guests enjoy access to quality shampoo, conditioner, body wash, hand soap, and moisturizing lotion, all selected to enhance relaxation.',
      'Ventilation and lighting are carefully planned to maintain a fresh and pleasant environment at all times. Bright overhead lights combined with task lighting around the mirror ensure visibility, while efficient ventilation keeps the space dry and comfortable after use.',
      'Storage solutions such as shelves, towel racks, and under sink cabinets help families keep their toiletries and personal items neatly arranged throughout their stay.',
      'The deluxe bathroom at Agroterra Resort is more than a functional space; it is a private wellness area where guests can refresh, recharge, and enjoy moments of relaxation.',
    ],
...
// ── Animated paragraph ────────────────────────────────────────────
function AnimatedParagraph({ children, delay = 0, t }: { children: React.ReactNode; delay?: number; t: Theme }) {
  return (
    <motion.p
    ...
    <div className={`${t.page} min-h-screen eb-garamond transition-colors duration-300 overflow-x-hidden`}>
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-10 pb-10">
        ...
        >
          ...
          {/* Hero image */}
          <MediaContainer t={t}>
            <Image src={deluxe} alt={activeTab === 'bedroom' ? 'Deluxe bedroom' : 'Deluxe bathroom'}
          ...
          <div>
            {content.paragraphs.map((text, i) => (
              <AnimatedParagraph key={i} delay={i * 0.08} t={t}>{text}</AnimatedParagraph>
            ))}
          </div>
