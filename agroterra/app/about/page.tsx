...
export default function page() {
  useEffect(() => {
    ...
    sections.forEach((section) => {
      const textElements = section.querySelectorAll('h2, p, span');
      ...
      // Image scale and fade with parallax effect
      if (img) {
        gsap.from(img, {
          scale: 1.2,
          opacity: 0,
  ...
  return (
    <div className="pb-116">
            ...
            <div className="absolute top-8 w-full h-[93vh] bg-[#00000075] flex flex-col px-12 py-6">
              ...
              <div className="h-full flex flex-col text-white items-center justify-center leading-relaxed">
                <div className="flex flex-col justify-center items-center -mt-26">
                  <h2 className="text-center eb-garamond-semibold text-[52px] welcome-text hero-text">AGROTERRA</h2>
                  <p className="eb-garamond-italic text-[28px] max-w-140 text-center hero-text">Where nature, comfort, and experience meet.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* ====================== ABOUT SECTION ====================== */}
      <div className="flex px-40 pb-20 pt-8 gap-20 items-center justify-center animate-section">
        ...
        <Image src={aboutImage} alt="About Agroterra Resort" className="w-160 h-100 animate-image" />
      </div>

      {/* ====================== RELAXATION SECTION ====================== */}
      <div className="flex px-30 py-24 gap-20 items-center justify-between bg-zinc-100 animate-section">
        <Image src={background1} alt="About Agroterra Resort" className="w-160 h-90 animate-image" />
        <div className="flex flex-col gap-3">
      ...
      {/* ====================== GOLF SECTION ====================== */}
      <div className="flex px-40 py-24 gap-20 items-center justify-between animate-section">
        <div className="flex flex-col gap-3">
        ...
        <Image src={background7} alt="Golf at Agroterra Resort" className="w-160 h-100 animate-image" />
      </div>

      {/* ====================== KITCHEN SECTION ====================== */}
      <div className="flex px-40 py-24 gap-20 items-center justify-between bg-zinc-100 animate-section">
        <Image src={background3} alt="Kitchen at Agroterra Resort" className="w-140 h-90 animate-image" />
        <div className="flex flex-col gap-3">
      ...
      {/* ====================== SHEEDXFM SECTION ====================== */}
      <div className="flex px-30 py-24 gap-20 items-center justify-between animate-section">
        <div className="flex flex-col gap-3">
        ...
        <Image src={background4} alt="SheedXfm at Agroterra Resort" className="w-140 h-90 animate-image" />
      </div>

      {/* ====================== SPORT ACADEMY SECTION ====================== */}
      <div className="flex px-40 py-24 gap-20 items-center justify-between bg-zinc-100 animate-section">
        <Image src={background6} alt="Sport Academy at Agroterra Resort" className="w-140 h-90 animate-image" />
        <div className="flex flex-col gap-3">
      ...
      <div className="flex px-40 py-24 gap-20 items-center justify-between animate-section">
        ...
        <Image src={securityImage} alt="Security at Agroterra Resort" className="w-140 h-90 rounded-lg object-cover animate-image" />
      </div>

      {/* ====================== EXTRA SECTION ====================== */}
      <div className="flex px-40 py-24 items-center relative justify-center bg-zinc-100 text-white animate-section">
        <div className="relative">
          <Image src={background8} alt="Sport Academy at Agroterra Resort" className="w-280 h-120 animate-image" />
          <div className="absolute top-11 w-full h-full bg-[#00000045]"></div>
        </div>
        <div className="flex flex-col absolute top-[60%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 gap-3">
